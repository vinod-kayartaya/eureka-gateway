...
select count(*) "Row count in categories table" from categories;
select count(*) "Row count in suppliers table" from suppliers;
select count(*) "Row count in products table" from products;
select count(*) "Row count in shippers table" from shippers;
select count(*) "Row count in employees table" from employees;
select count(*) "Row count in customers table" from customers;
select count(*) "Row count in orders table" from orders;
select count(*) "Row count in order_details table" from order_details;
